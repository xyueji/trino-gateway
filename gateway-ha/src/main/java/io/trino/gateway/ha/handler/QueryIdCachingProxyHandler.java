...
public class QueryIdCachingProxyHandler extends ProxyHandler {
    ...
    public static final String V1_SERVICE_PATH = "/v1/service";
    public static final String V1_ANNOUNCEMENT_PATH = "/v1/announcement";
    ...
    private boolean isPathWhiteListed(String path) {
        return path.startsWith(V1_STATEMENT_PATH)
                ...
                || path.startsWith(V1_SERVICE_PATH)
                || path.startsWith(V1_ANNOUNCEMENT_PATH)
